  ...
  try {
    ...
    try {
      ...
      try {
        ...
        template = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><title>Anvitam</title></head><body><div id="root"></div></body></html>`;
      }
    }
    ...
    console.error('[ssr-seo] Top-level handler catch error:', handlerErr);
    let fallbackHtml = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><title>Anvitam</title></head><body><div id="root"></div></body></html>`;
    try {
      fallbackHtml = fs.readFileSync(path.join(process.cwd(), 'dist/index.html'), 'utf8');
    } catch {}
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
