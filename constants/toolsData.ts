...
export const TOOLS_SUITE: ToolItem[] = [
  {
    ...
    category: 'Sun & Site',
    shortDesc: 'Transform room photos into photorealistic interiors, restyle decor, and shop matched catalog items.',
    fullDesc: 'Upload living room, bedroom, kitchen, or office photos for AI-powered interior redesign with shoppable furniture pins.',
    features: [
      '🛋️ 15+ Architectural interior room styles',
  ...
  {
    id: 'ai-exterior-facade',
    name: 'AI Exterior Facade Design Studio',
    category: 'Sun & Site',
    shortDesc: 'Refresh building exteriors, home facades, modern cladding, and architectural elevation render.',
    fullDesc: 'Upload home exterior or building photos to generate photorealistic facade redesigns with modern materials.',
    features: [
      '🏡 Modern facade, timber cladding, glass & natural stone renders',
      '↔️ High-fidelity before/after split slider',
      '💎 Watermark-free 4K HD export downloads'
    ],
  ...
  {
    id: 'ai-garden-landscape',
    name: 'AI Garden & Yard Landscape Studio',
    category: 'Sun & Site',
    shortDesc: 'Design gardens, courtyards, permaculture yards, patio seating, and biophilic outdoor spaces.',
    fullDesc: 'Transform outdoor yards, gardens, and terraces with AI landscape designs, planting ideas, and outdoor lighting.',
    features: [
      '🌿 Permaculture food forest & garden zoning',
      '🌾 Outdoor patio, fire pit, and terrace redesigns',
      '🏷️ Shoppable outdoor furniture pins'
    ],
    href: '/tools/ai-home-design?module=garden',
    status: 'live',
    badge: 'GARDEN AI',
    iconBg: 'bg-emerald-900 text-[#CCFF00]',
    iconColor: 'text-[#CCFF00]',
    iconSvg: React.createElement(Trees, { size: 24 }),
    previewImage: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?q=80&w=1200&auto=format&fit=crop',
  },
  {
    id: 'ai-furniture-replace',
    name: 'AI Replace & Add Furniture Studio',
    category: 'Sun & Site',
    shortDesc: 'Instantly add or replace sofas, tables, lighting, and decor items in existing room photos.',
    fullDesc: 'Select specific furniture items in your photo and replace them with modern, regional catalog products.',
    features: [
      '🪑 AI item replacement & catalog matching',
      '🛒 Shoppable catalog integration for India, USA, Brazil'
    ],
    ...
    previewImage: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1200&auto=format&fit=crop',
  },
  {
    id: 'ai-furniture-removal',
    name: 'AI Furniture Removal & Declutter Studio',
    category: 'Sun & Site',
    shortDesc: 'Erase unwanted furniture, clutter, and objects from room photos in one click.',
    fullDesc: 'Clean up room photos by removing old furniture, wires, or clutter, leaving empty walls and floors ready for staging.',
    features: [
      '🧹 Instant object & furniture removal',
      '🏠 Seamless background floor & wall texture fill'
    ],
    href: '/tools/ai-home-design?module=remove',
    status: 'live',
    badge: 'CLEANUP AI',
    iconBg: 'bg-neutral-900 text-[#CCFF00]',
    iconColor: 'text-[#CCFF00]',
