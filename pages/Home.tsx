...
function AsSeenOnSection() {
  const badgeItems = [
    ...
    {
      id: 'indiehunt',
      href: 'https://indiehunt.io/project/anvitam',
      target: '_blank',
      rel: 'noopener',
    ...
    {
      id: 'makerhunt',
      href: 'https://makerhunt.io/project/anvitam',
      target: '_blank',
      rel: 'noopener',
      title: 'Featured on MakerHunt',
      imgSrc: 'https://makerhunt.io/badges/makerhunt-badge-light.svg',
    ...
    {
      id: 'sidehunt',
      href: 'https://sidehunt.io/project/anvitam',
      target: '_blank',
      rel: 'noopener',
      title: 'View project on Sidehunt',
      imgSrc: 'https://sidehunt.io/badges/sidehunt-badge-light.svg',
      alt: 'Featured on Sidehunt',
      width: 200,
      height: 60,
      imgClass: 'h-9 sm:h-11 w-auto object-contain',
    },
    {
      ...
      target: '_blank',
      rel: 'noopener',
      imgSrc: 'https://uno.directory/uno-directory.svg',
