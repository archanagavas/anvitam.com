...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#EFEFEB] text-[#111] font-sans overflow-hidden">
      ...
      {/* ══════════════════════════════════════════
          ECOLOGICAL PERFORMANCE TABLE & E-E-A-T QUOTE
      ══════════════════════════════════════════ */}
        ...
        <div className="max-w-screen-xl mx-auto">
          <FadeUp>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold leading-[1.1] tracking-tight text-[#111] mb-4">
                Ecological Design Impact
              </h2>
              <p className="text-[#555] max-w-2xl mx-auto text-base">
                A comparative look at how sustainable architectural principles outperform conventional build methods.
              </p>
            </div>
          </FadeUp>
          ...
          <FadeUp delay={0.1}>
            <div className="overflow-x-auto rounded-2xl border border-black/5 shadow-sm">
              <table className="w-full text-left border-collapse bg-white">
                <thead>
                  <tr className="bg-[#03160E] text-[#CCFF00] border-b border-black/10">
                    <th className="p-6 text-sm font-bold uppercase tracking-wider">Design Metric</th>
                    <th className="p-6 text-sm font-bold uppercase tracking-wider">Conventional Building</th>
                    <th className="p-6 text-sm font-bold uppercase tracking-wider">Anvitam Ecological Design</th>
                    <th className="p-6 text-sm font-bold uppercase tracking-wider">Net Environmental Benefit</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-black/5 text-sm text-[#555]">
                  <tr className="hover:bg-[#EFEFEB]/20 transition-colors">
                    <td className="p-6 font-bold text-[#111]">Carbon Footprint</td>
                    <td className="p-6 text-red-600">High (+39% global emissions)</td>
                    <td className="p-6 text-emerald-700 font-semibold">Negative (Carbon-sequestering earth & bamboo)</td>
                    <td className="p-6 font-bold text-emerald-700">100% Net Reduction</td>
                  </tr>
                  <tr className="hover:bg-[#EFEFEB]/20 transition-colors">
                    <td className="p-6 font-bold text-[#111]">Water Self-Sufficiency</td>
                    <td className="p-6 text-red-600">0% (Relies on municipal/groundwater depletion)</td>
                    <td className="p-6 text-emerald-700 font-semibold">100% (Rainwater harvesting & greywater reuse)</td>
                    <td className="p-6 font-bold text-emerald-700">Zero external water dependency</td>
                  </tr>
                  <tr className="hover:bg-[#EFEFEB]/20 transition-colors">
                    <td className="p-6 font-bold text-[#111]">Indoor Microclimate</td>
                    <td className="p-6 text-red-600">Unregulated (Requires mechanical AC/heating)</td>
                    <td className="p-6 text-emerald-700 font-semibold">Self-regulating (Thermal mass earth walls)</td>
                    <td className="p-6 font-bold text-emerald-700">60% reduction in energy loads</td>
                  </tr>
                  <tr className="hover:bg-[#EFEFEB]/20 transition-colors">
                    <td className="p-6 font-bold text-[#111]">Ecosystem Biodiversity</td>
                    <td className="p-6 text-red-600">Negative (Soil compaction & concrete cover)</td>
                    <td className="p-6 text-emerald-700 font-semibold">Positive (Syntropic agroforestry & food forests)</td>
                    <td className="p-6 font-bold text-emerald-700">Restores native flora/fauna habitats</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* E-E-A-T Quote from Archana Gavas */}
          <FadeUp delay={0.2}>
            <div className="max-w-3xl mx-auto mt-16 text-center border-l-4 border-[#CCFF00] pl-6 py-2 text-left bg-[#EFEFEB]/30 rounded-r-2xl p-6">
              <blockquote className="text-lg md:text-xl italic text-[#333] leading-relaxed">
              ...
              <cite className="block mt-4 text-sm font-bold uppercase tracking-wider text-[#111] not-italic">
                — Ar. Archana Gavas, Principal Architect (published in Anvitam Ecological Journal, 2025)
              </cite>
            </div>
          </FadeUp>
        </div>
